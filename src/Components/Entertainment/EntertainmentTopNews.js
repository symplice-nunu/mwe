...
export default function EntertainmentTopNews() {
  ...
  <div className=" text-white flex items-end pb-[30px] pl-[25px] pr-[84px] bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/02/13-750x375.jpg')] bg-cover bg-center w-full">
  ...
  <div className="bg-teal-400  flex items-end w-[790px] h-[350px] pb-[30px] px-[15px] text-white  bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/02/03-750x375.jpg')] bg-cover bg-center" >
  <div className='w-full'>
  ...
  <div className=" bg-blue-300 h-[230px] flex items-end pb-[30px] px-[15px] text-white bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/01/19-750x375.jpg')] bg-cover bg-center">
  <div className='w-full'>
      <div className='bg-[#9f4bc3] rounded font-[heebo] text-[11px] py-[4px] px-[7px] w-[108px]'>ENTERTAINMENT</div>
      <div className='text-[18px] font-[Poppins] py-3'>Instagram Is Testing Photo Albums, Because Nothing is Sacred Anymore</div>
      <div className='flex space-x-3'>
  ...
  <div className="  bg-blue-300 h-[230px] flex items-end pb-[30px] px-[15px] text-white bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/01/18-750x375.jpg')] bg-cover bg-center bg-no-repeat">
  <div className='w-full'>
