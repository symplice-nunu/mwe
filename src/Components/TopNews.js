...
export default function TopNews() {
  return (
    <div className='flex space-x-[2px] my-8'>
        <div className=" text-white flex items-end pb-[30px] pl-[25px] pr-[84px] bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/02/03-750x375.jpg')]  w-full">
        ...
        <div className="bg-teal-400 w-[590px] flex items-end pb-[30px] px-[15px] text-white  bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/01/19-750x375.jpg')]" >
        <div className='w-full'>
        ...
        <div className="w-[270px] bg-blue-300 h-[230px] flex items-end pb-[30px] px-[15px] text-white bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/01/18-750x375.jpg')]">
        <div className='w-full'>
            <div className='bg-[#9f4bc3] rounded font-[heebo] text-[11px] py-[4px] px-[7px] w-[108px]'>ENTERTAINMENT</div>
            <div className='text-[18px] font-[Poppins] py-3'>Instagram Is Testing Photo Albums, Because Nothing is Sacred Anymore</div>
            <div className='flex space-x-3'>
        ...
        <div className="w-[270px] bg-blue-300 h-[230px] flex items-end pb-[30px] px-[15px] text-white bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/02/05-750x375.jpg')] bg-no-repeat">
        <div className='w-full'>
