...
export default function WorldTopNews() {
  ...
  <div className=" text-white flex items-end pb-[30px] lg:auto xl:h-auto h-[350px] pl-[25px] pr-[84px] bg-[url('https://jnews.io/bloomnews/wp-content/uploads/sites/75/2020/02/01-750x375.jpg')] bg-cover bg-center w-full">
  ...
  <div className='space-y-[2px] lg:flex xl:flex md:flex gap-[2px] '>
